#!/usr/bin/env python3
"""
Create Thailand-Cambodia Invasion Report with working modals AND advanced tooltips.
Combines the best of both: working modal functionality + advanced tooltip system.
"""
import os
import datetime
import json
...
def create_cambodia_report_with_tooltips():
    """Create Cambodia report with working modals AND advanced tooltips."""
    
    # Generate module cards HTML with tooltips
    module_cards_html = ""
    for i, module in enumerate(CAMBODIA_MODULES, 1):
        tooltip_data = json.dumps(module['tooltip']).replace('"', '&quot;')
        module_cards_html += f"""
                <div class="module-card" 
                     onclick="showModuleDetails('{module['id']}')"
                     onmouseover="showEnhancedTooltip(event, {json.dumps(module['tooltip'])})"
...
<head>
    ...
    <title>Thailand-Cambodia Invasion Analysis - With Advanced Tooltips</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="subtitle">Enhanced Version with Working Modals AND Advanced Tooltips</div>
    ...
    filename = f"thailand_cambodia_with_tooltips_{timestamp}.html"
    ...
    print(f"✅ Cambodia report with tooltips created: {filename}")
    print(f"📁 Location: {filepath}")
    print(f"🔧 Working modal functionality + Advanced tooltips")
...
if __name__ == "__main__":
    print("🚀 Creating Thailand-Cambodia Invasion Report with Advanced Tooltips...")
    report_path = create_cambodia_report_with_tooltips()
    if report_path:
        print(f"\n🎉 Report created successfully!")
        print(f"📄 Open {report_path} in your browser")
        print(f"💡 Hover over module cards to see advanced tooltips")
        print(f"🖱️ Click on module cards to open detailed modals")
        print(f"✅ This version has BOTH working modals AND advanced tooltips")
