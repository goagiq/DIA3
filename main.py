...
def initialize_enhanced_report_system():
    ...
    try:
        ...
        try:
            ...
            print("   - Integrated adaptive modular report system available: ✅")
        except ImportError as e:
            ADAPTIVE_MODULAR_REPORT_AVAILABLE = False
            print(f"   - Integrated adaptive modular report system not available: {e}")
...
if __name__ == "__main__":
    ...
    # Initialize integrated adaptive modular report system with enhanced capabilities
    print("Initializing enhanced adaptive modular report system...")
    try:
        from src.core.integrated_adaptive_modular_report_generator import integrated_adaptive_modular_report_generator
        from src.core.adaptive_data_adapter import AdaptiveDataAdapter
        
        # Test the adaptive system
        test_adapter = AdaptiveDataAdapter()
        print("✅ Enhanced adaptive modular report system initialized")
        print("   - Adaptive data adapter ready with contextual intelligence")
        print("   - Universal data generation with domain-specific adaptation")
        print("   - All 22 modules generated by default with interactive visualizations")
        print("   - Natural language query processing with context awareness")
        print("   - Regional analysis adapts to topic context (healthcare, tech, finance, geopolitical)")
        print("   - Robust data validation and early error detection")
        print("   - Advanced tooltips and Chart.js integration")
        
        # Test with a contextual query
        test_data = test_adapter.generate_universal_data("Test adaptive system functionality", [])
        print(f"   - Test data generation: {len(test_data)} sections created with adaptive context")
        print("   - Contextual regional analysis enabled")
        print("   - Interactive visualizations validated")
        
    except ImportError as e:
        print(f"⚠️ Warning: Integrated adaptive modular report system not available: {e}")
    except Exception as e:
        print(f"⚠️ Warning: Error initializing adaptive modular report system: {e}")
    ...
    print("")
    print("📄 Markdown Export Endpoints:")
    print("   - /api/v1/markdown-export/health - Markdown export service health check")
    print("   - /api/v1/markdown-export/export - Export markdown content to PDF/Word")
    print("   - /api/v1/markdown-export/export-file - Export markdown file to PDF/Word")
    print("   - /api/v1/markdown-export/download/{filename} - Download exported file")
    ...
    print("   - /api/v1/enhanced-reports/generate - Generate enhanced report (adaptive by default)")
    print("   - /api/v1/enhanced-reports/generate-adaptive - Generate adaptive report with all 22 modules")
    print("   - /api/v1/enhanced-reports/generate-modular - Generate modular report with configurable components")
    print("   - /api/v1/enhanced-reports/generate-beautiful - Generate beautiful enhanced report")
    print("   - /api/v1/enhanced-reports/generate-with-tooltips - Generate enhanced report with interactive tooltips")
    ...
    print("   - Adaptive Test: .venv/Scripts/python.exe Test/test_adaptive_report_integration.py")
    print("")
