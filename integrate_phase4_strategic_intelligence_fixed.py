...
async def generate_strategic_intelligence_report():
    ...
    # Use a shorter topic to avoid path length issues
    topic = "Pakistan Submarine Acquisition Strategic Analysis"
    ...
    try:
        ...
        result = await generator.generate_modular_report(
            ...
            output_format="html",
            title="Strategic Intelligence Analysis"  # Shorter title
        )
