"""
Simple MCP client test using mcp-client library
"""
import sys
import os
import json
...
def test_simple_mcp_client():
    """Test MCP client using mcp-client library."""
    ...
    try:
        ...
        if phase5_tools:
            ...
            try:
                # Call the tool
                result = client.call_tool(test_tool.name, {})
        ...
        print("\n" + "=" * 50)
        print("🏁 Simple MCP Client Test Complete")
        print("\n📋 Summary:")
